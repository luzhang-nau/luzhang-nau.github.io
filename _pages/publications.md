...
4. <span style="color: red">(CJC'25，CCF T1)</span> <span style="color: blue">基于异步个性化联邦学习的DDoS攻击检测与缓解</span> <br />
   朱海婷, 魏明岗, 刘丰宁, 何高峰, **张璐**<sup>✉</sup>. <span class="paper-source">计算机学报</span>, 2025, 48(04): 808-827.（通讯作者）
...
6. <span style="color: red">(INS'24, JCR Q1, CCF B)</span> <span style="color: blue">Collusive spam detection from Chinese community question answering sites: A collective classification framework</span> <br />
   **Lu Zhang**, Mingming Xu, Zhan Bu, Gaofeng He, Haiting Zhu, Changjian Fang. <span class="paper-source">Information Sciences</span>, 2024, 667: 120379.
...
7. <span style="color: red">(CBD'24)</span> <span style="color: blue">Enhancing GNN-based CQA spam detection: Question-answer-pair perspective with supervised neighbor selection</span> <br />
   Chenyang Wei, Xi Luo, **Lu Zhang**, Gaofeng He, Haiting Zhu. <span class="paper-source">The 2024 Twelfth International Conference on Advanced Cloud and Big Data (CBD)</span>, 2024. <span style="color: red">(Best Student Paper Award)</span>
...
8. <span style="color: red">(TIE'24, JCR Q1)</span> <span style="color: blue">Electrical Fault Diagnosis From Text Data: A Supervised Sentence Embedding Combined With Imbalanced Classification</span> <br />
   Xiao Jing, Zhiang Wu, **Lu Zhang**, Zhe Li, Dejun Mu. <span class="paper-source">IEEE Transactions on Industrial Electronics</span>, 2024, 71(3): 3064-3073.
...
9. <span style="color: red">(TSMCS'22, JCR Q1)</span> <span style="color: blue">Community Detection via Local Learning Based on Generalized Metric with Neighboring Regularization</span> <br />
   Guangliang Gao, Zhiang Wu, **Lu Zhang**, Jie Cao, Xinzhe Qi. <span class="paper-source">IEEE Transactions on Systems, Man, and Cybernetics: Systems</span>, 2022, 52(1): 498-510.
...
10. <span style="color: red">(ESWA'20, JCR Q1)</span> <span style="color: blue">Personalized Itinerary Recommendation: Deep and Collaborative Learning with Textual Information</span> <br />
    Lei Chen, **Lu Zhang***, Shanshan Cao, Zhiang Wu, Jie Cao. <span class="paper-source">Expert Systems with Applications</span>, 2020, 144: 113070.（通讯作者）
...
11. <span style="color: red">(TCYB'20, JCR Q1, CCF B)</span> <span style="color: blue">hPSD: A Hybrid PU-Learning-Based Spammer Detection Model for Product Reviews</span> <br />
    Zhiang Wu, Jie Cao, Yaqiong Wang, Youquan Wang, **Lu Zhang**, Junjie Wu. <span class="paper-source">IEEE Transactions on Cybernetics</span>, 2020, 50(4): 1595-1606.
...
14. <span style="color: red">(JOCS'18, JCR Q1)</span> <span style="color: blue">A Pattern-Based Topic Detection and Analysis System on Chinese Tweets</span> <br />
    **Lu Zhang**, Zhiang Wu, Zhan Bu, Ye Jiang, Jie Cao. <span class="paper-source">Journal of Computational Science</span>, 2018, 28: 369-381.
...
15. <span style="color: red">(CCPE'18)</span> <span style="color: blue">Spotting Review Spammer Groups: A Cosine Pattern and Network Based Method</span> <br />
    **Lu Zhang**, Gaofeng He, Jie Cao, Haiting Zhu, Bingfeng Xu. <span class="paper-source">Concurrency and Computation: Practice and Experience</span>, 2018, 30(20): e4686.
